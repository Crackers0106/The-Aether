...
public class AetherConfiguredFeatures {
    ...
    public static ConfiguredFeature<TreeFeatureConfig, ?> GOLDEN_OAK_TREE, CRYSTAL_TREE, SKYROOT_TREE, BLUE_SKYROOT_TREE, ROSE_WISTERIA_TREE, LAVENDER_WISTERIA_TREE, FROST_WISTERIA_TREE, FANCY_ROSE_WISTERIA_TREE, FANCY_LAVENDER_WISTERIA_TREE, FANCY_FROST_WISTERIA_TREE, FANCY_SKYROOT_TREE, BOREAL_WISTERIA_TREE, FANCY_BOREAL_WISTERIA_TREE;
    ...
    public static void registerFeatures() {
        ...
        BLUE_SKYROOT_TREE = register("blue_skyroot_tree", Feature.TREE.configure(Configs.BLUE_SKYROOT_CONFIG));
    ...
    public static class Configs {
        ...
        public static final TreeFeatureConfig BLUE_SKYROOT_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(AetherBlocks.SKYROOT_LOG.getDefaultState()), new SimpleBlockStateProvider(AetherBlocks.BLUE_SKYROOT_LEAVES.getDefaultState()), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
        ...
        public static final RandomFeatureConfig RAINBOW_FOREST_CONFIG = new RandomFeatureConfig(
                ImmutableList.of(Feature.TREE.configure(LAVENDER_WISTERIA_CONFIG).withChance(0.33F), Feature.TREE.configure(ROSE_WISTERIA_CONFIG).withChance(0.075F), Feature.TREE.configure(FROST_WISTERIA_CONFIG).withChance(0.0001F), Feature.TREE.configure(BLUE_SKYROOT_CONFIG).withChance(0.2F), Feature.TREE.configure(SKYROOT_CONFIG).withChance(0.1F)),
        ...
        public static final RandomFeatureConfig SPARSE_TREES_CONFIG = new RandomFeatureConfig(
                ImmutableList.of(Feature.TREE.configure(SKYROOT_CONFIG).withChance(0.11F), Feature.TREE.configure(GOLDEN_OAK_CONFIG).withChance(0.0025F)),
                Feature.TREE.configure(Configs.SKYROOT_CONFIG)
        );
    }
}
